...
class Enemy:
    def prepare_patrol_points(self):
        positions = [(1200, 215), (1300, 215), (1400, 215), (1500, 215), (1600, 215), (1700, 215), (1600, 215),
                     (1500, 215), (1400, 215), (1300, 215)]
        self.patrol_points = []
        for p in positions:
    ...
    def __init__(self):
        ...
        # self.attack_sound = load_wav('./resource/AudioClip/heavy_sword_attack')
